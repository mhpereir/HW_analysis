#!/bin/bash
#PBS -N stage_2_plot_event_baseline_compare
#PBS -l select=1:ncpus=4:mem=16gb
#PBS -j oe
#PBS -o /dev/null

LOGFILE="/home/mhpereir/HW_analysis/logs/${PBS_JOBID}_plot_advection_comparison_baseline.log"
...
OUTPUT_PATH="/home/mhpereir/HW_analysis/results/stage2_baseline_features/diagnostics/${REGION}/${THRESHOLD_VARIABLE}/event_vs_clean_baseline_adiabatic_advection_comparison.png"
POINT_SIZE=24.0
ALPHA=0.2
...
echo "[info] $(date -Is) starting event-versus-clean-baseline comparison plot generation on host $(hostname)"
/usr/bin/time -v python event_features/plot_adiabatic_advection_comparison_baseline.py \
