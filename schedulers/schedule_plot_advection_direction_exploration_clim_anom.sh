#!/bin/bash
#PBS -N advection_direction_clim_anom
...
hwa_start_log "plot_advection_direction_clim_anom"
hwa_validate_artifact_paths INPUT_PATH CLIMATOLOGY_PATH OUTPUT_PATH
