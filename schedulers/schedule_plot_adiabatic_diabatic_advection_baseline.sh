#!/bin/bash
#PBS -N plot_diabatic_advection_base
...
hwa_start_log "plot_adiabatic_diabatic_advection_baseline"
...
cd "${PROJECT_ROOT}"
/usr/bin/time -v python scripts/event_features/plot_adiabatic_diabatic_advection_baseline.py \
