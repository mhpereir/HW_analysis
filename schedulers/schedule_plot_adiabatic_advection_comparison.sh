...
OUTPUT_PATH="/home/mhpereir/HW_analysis/results/stage2_event_features/diagnostics/${REGION}/${THRESHOLD_VARIABLE}/event_adiabatic_advection_comparison.png"
POINT_SIZE=24.0
ALPHA=0.7
...
/usr/bin/time -v python event_features/plot_adiabatic_advection_comparison.py \
