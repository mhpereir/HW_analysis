...
hwa_start_log "plot_top_events_clim_anom"
hwa_validate_artifact_paths INPUT_PATH CLIMATOLOGY_PATH OUTPUT_DIR
...
cd "${PROJECT_ROOT}"
/usr/bin/time -v python scripts/plot_top_events_clim_anom.py \
  --region "${REGION}" \
