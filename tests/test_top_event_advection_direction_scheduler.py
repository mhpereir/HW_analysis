...
def test_top_event_advection_scheduler_is_commit_verified_and_atomic():
    ...
    assert "plot_advection_direction_exploration_top_events_clim_anom.py" in text
...
def test_top_event_advection_scheduler_accepts_runtime_plot_configuration():
    text = SCHEDULER.read_text()
    expected_defaults = {
